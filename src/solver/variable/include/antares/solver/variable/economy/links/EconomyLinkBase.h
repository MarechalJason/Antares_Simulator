...
struct VCardEconomyLinkBase
{
    ...
    typedef VCardEconomyLinkBase VCardForSpatialAggregate;
...
}; // class VCardEconomyLinkBase

template<class Traits, class NextT = Container::EndOfList>
class EconomyLinkBase: public Variable::IVariable<EconomyLinkBase<Traits, NextT>,
                                                  NextT,
                                                  VCardEconomyLinkBase<Traits>>
{
public:
    //! Type of the next static variable
    typedef NextT NextType;
    //! VCard
    typedef VCardEconomyLinkBase<Traits> VCardType;
    //! Ancestor
    typedef Variable::IVariable<EconomyLinkBase<Traits, NextT>, NextT, VCardType> AncestorType;
...
public:
    ...
    {
        // Store the value for the current hour
