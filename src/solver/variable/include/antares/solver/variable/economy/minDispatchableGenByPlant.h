...
struct MinDispatchableGenByPlantTraits
{
                                              ...
                                              State& state)
    {
        ...
        for (auto& cluster: area->thermal.list.each_enabled())
        {
            ...
            double production = thermal[area->index].thermalClustersProductions[cluster->enabledIndex];
...
using VCardMinDispatchableGenByPlant =
  VCardDispatchablePlantByClusterBase<MinDispatchableGenByPlantTraits>;

/*!
** \brief Energy generated by all thermal dispatchable clusters
*/
template<class NextT = Container::EndOfList>
using MinDispatchableGenByPlant = DispatchablePlantByClusterBase<
