Feature: reserves symmetry tests
  ...
  Scenario: Thermal_cluster_symmetry_test_1
    ...
    And in area "FRANCE", during year 1, for reserve "res_1_up", reserve unsupplied power is always equal to 30 MWh
  ...
  Scenario: ST_symmetry_test_2
    ...
    And in area "FRANCE", during year 1, for reserve "res_1_up", reserve unsupplied power is always equal to 14 MWh
