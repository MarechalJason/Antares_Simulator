...
@fast @short
  Scenario: ST_1UP_reserves_test1
    Given the study path is "reserves_tests/ST_1_reserves"
...
@fast @short
  Scenario: ST_2UP_reserves_test1
    Given the study path is "reserves_tests/ST_2_reserves"
...
@fast @short
  Scenario: ST_3UP_unavailable_reserves_test1
    Given the study path is "reserves_tests/ST_3_reserves"
